...
function saveSetting(req, res) {
  ...
  if (readConfigOrigin.connectionType === 'keycloak'
      && reqConfig.role
      && reqConfig.role !== readConfigOrigin.role) {
    restartApp = true;
  }
...
async function addDevice(req, res) {
  ...
  device.updatable = ['battery', 'doors', 'hvac', 'preaccont'].includes(device.actionId);
